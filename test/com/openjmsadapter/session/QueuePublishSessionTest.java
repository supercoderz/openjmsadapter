/*
 * $HeadURL: file:///nfs/sf-svn/o/op/openjmsadapter/code/openjmsadapter/test/com/openjmsadapter/session/QueuePublishSessionTest.java $
 * $Revision: 36 $
 ...
 * @author hari
 */
public class QueuePublishSessionTest {

    @Test
    public void testCreateQueuePublishSession() throws FileNotFoundException,JMSException, OpenJMSAdapterException{
    ...
    public void testDiconnectDisconnectedQueuePublishSession() throws FileNotFoundException,JMSException, OpenJMSAdapterException{
        ...
        connection.connect();
        connection.createQueuePublishingSession("test.queue");
        QueuePublishSession session = (QueuePublishSession) connection.getQueuePublishSession("test.queue");
        connection.disconnect();
        session.disconnect();
    }
    ...
    public void testPublishBytesMessage() throws FileNotFoundException,JMSException, OpenJMSAdapterException{
        ...
        MessageConsumer consumer = receive_session.createConsumer(receive_session.createQueue("test.queue"));
