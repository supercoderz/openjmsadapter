/*
 * $HeadURL: file:///nfs/sf-svn/o/op/openjmsadapter/code/openjmsadapter/test/com/openjmsadapter/client/database/DatabaseOpenMQClientTest.java $
 * $Revision: 36 $
 ...
 * @author hari
 */
public class DatabaseOpenMQClientTest {

    @Test
    public void testCreateOpenMQClient() throws OpenJMSAdapterException, FileNotFoundException {
        assertNotNull(new OpenMQClient("C:/NetBeansProjects/openjmsadapter/test/test_hibernate.cfg_2.xml"));
    }

    
    @Test
    public void testConnectDisconnectOpenMQClient() throws OpenJMSAdapterException, FileNotFoundException {
        OpenMQClient client = new OpenMQClient("C:/NetBeansProjects/openjmsadapter/test/test_hibernate.cfg_2.xml");
        client.connect();
        client.disconnect();
    }
    ...
    public void testPublishToQueueAsBytesAndReceive() throws OpenJMSAdapterException, FileNotFoundException {
        ...
        client.disconnect();
        OpenMQClient client1 = new OpenMQClient("C:/NetBeansProjects/openjmsadapter/test/test_hibernate.cfg_3.xml");
        client1.connect();
