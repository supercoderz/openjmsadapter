/*
 * $HeadURL: file:///nfs/sf-svn/o/op/openjmsadapter/code/openjmsadapter/test/com/openjmsadapter/client/database/DatabaseActiveMQClientTest.java $
 * $Revision: 36 $
 ...
 * @author hari
 */
public class DatabaseActiveMQClientTest {

    @Test
    public void testCreateActiveMQClient() throws OpenJMSAdapterException, FileNotFoundException {
        assertNotNull(new ActiveMQClient("C:/NetBeansProjects/openjmsadapter/test/test_hibernate.cfg.xml"));
    }
    

    @Test
    public void testConnectDisconnectActiveMQClient() throws OpenJMSAdapterException, FileNotFoundException {
        ActiveMQClient client = new ActiveMQClient("C:/NetBeansProjects/openjmsadapter/test/test_hibernate.cfg.xml");
        client.connect();
        client.disconnect();
    }
    ...
    public void testPublishToQueueAsBytesAndReceive() throws OpenJMSAdapterException, FileNotFoundException {
        ...
        client.disconnect();
        ActiveMQClient client1 = new ActiveMQClient("C:/NetBeansProjects/openjmsadapter/test/test_hibernate.cfg_1.xml");
        client1.connect();
