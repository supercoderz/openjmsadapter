/*
 * $HeadURL: file:///nfs/sf-svn/o/op/openjmsadapter/code/openjmsadapter/src/com/openjmsadapter/client/yaml/OpenMQClient.java $
 * $Revision: 35 $
...
import com.openjmsadapter.connection.OpenMQConnectionFactoryBuilder;
 ...
 * @author hari
 */
public class OpenMQClient extends YamlConfigClient{

    private static Logger logger = Logger.getLogger("OpenJMSAdapter");
    private OpenMQConnectionFactoryBuilder connectionFactoryBuilder;

    public OpenMQClient(String configFileName) throws FileNotFoundException {
    ...
    public void connect() throws OpenJMSAdapterException {
        ...
        connectionFactoryBuilder = new OpenMQConnectionFactoryBuilder();
